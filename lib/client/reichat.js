...
function init() {
	...
	standby = function () {
		...
		stat.contexts[5].mozImageSmoothingEnabled = false;
		stat.contexts[5].msImageSmoothingEnabled = false;
		stat.contexts[5].imageSmoothingEnabled = false;
	...
	tick = function () {
		...
		stat.contexts[0].clearRect(0, 0, stat.w, stat.h);
