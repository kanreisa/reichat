...
function init() {
	...
	listener.canvasOnPointerMove = function (e) {
		...
		var moved = false,
			x = typeof e.offsetX === 'number' ? e.offsetX : e.layerX || e.pageX + view.canvasContainer.scrollLeft - view.paint.offsetLeft,
			y = typeof e.offsetY === 'number' ? e.offsetY : e.layerY || e.pageY + view.canvasContainer.scrollTop - view.paint.offsetTop,
	...
	listener.canvasOnPointerDown = function (e) {
		...
		var x = stat.x = typeof e.offsetX === 'number' ? e.offsetX : e.layerX || e.pageX + view.canvasContainer.scrollLeft - view.paint.offsetLeft,
			y = stat.y = typeof e.offsetY === 'number' ? e.offsetY : e.layerY || e.pageY + view.canvasContainer.scrollTop - view.paint.offsetTop;
